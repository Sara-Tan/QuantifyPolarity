[![GitHub release](https://img.shields.io/github/v/release/QuantifyPolarity/QuantifyPolarity?include_prereleases&label=version&color=blue)](https://github.com/QuantifyPolarity/QuantifyPolarity/releases)
